...
public class LiquidWalletCoinControlTests
{
	...
	private static void AssertExactAssemblyTypeManifestsMatchBase()
	{
		...
		[
			...
			"WalletWasabi.Tests.UnitTests.Liquid.Wallet.Ui.LiquidWalletNativeFactsObserverTests+<>c",
			"WalletWasabi.Tests.UnitTests.Liquid.Wallet.Ui.LiquidWalletNativeFactsObserverTests+<>c__DisplayClass6_0",
			"WalletWasabi.Tests.UnitTests.Liquid.Wallet.Ui.LiquidWalletNativeFactsObserverTests+<>c__DisplayClass7_0",
			"WalletWasabi.Tests.UnitTests.Liquid.Wallet.Ui.LiquidWalletNativeFactsObserverTests+<>c__DisplayClass8_0",
			"WalletWasabi.Tests.UnitTests.Liquid.Wallet.Ui.LiquidWalletNativeFactsObserverTests+Fixture",
		...
		[
			...
			"WalletWasabi.Liquid.Wallet.Ui.LiquidWalletNativeFactsObserver",
			"WalletWasabi.Liquid.Wallet.Ui.LiquidWalletNativeFactsObserver+PlatformLibraryPin",
		...
		AssertExactAssemblyTypeManifest(
			...
			"WalletWasabi",
			1_768,
			"ff23e0b57cfebb8eb1b118b0b2dac97f55da2ea9403ae185d185b8260e961d1b",
			permittedAddedProductionTypes);
		AssertExactAssemblyTypeManifest(
			typeof(LiquidWalletCoinControlTests).Assembly,
			"WalletWasabi.Tests",
			1_782,
			"7d1cfcf40592ea8534589ff9395db4c3b83749912313ed9a845660a77b48ba26",
		...
		AssertExactAssemblyTypeManifest(
			...
			"WalletWasabi",
			1_765,
			"5d088d9dd32cd5d8e49f575eeb0f61c63108c53dfba02198fe6aee17429dfc9f",
			permittedAddedProductionTypes);
		AssertExactAssemblyTypeManifest(
			typeof(LiquidWalletCoinControlTests).Assembly,
			"WalletWasabi.Tests",
