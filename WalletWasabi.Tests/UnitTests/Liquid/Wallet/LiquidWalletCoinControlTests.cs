...
public class LiquidWalletCoinControlTests
{
	...
	private static void AssertExactAssemblyTypeManifestsMatchBase()
	{
		...
		AssertExactAssemblyTypeManifest(
			...
			"WalletWasabi",
			1_698,
			"bf8ff71d6456a2daf1ee5a290b4f6f4bae261aff1babedabf56d1de0be5fceac");
		AssertExactAssemblyTypeManifest(
			typeof(LiquidWalletCoinControlTests).Assembly,
			"WalletWasabi.Tests",
			1_659,
			"700f86e13dadd008bc1403481bb0db5afcad4ea455141c8be143c9e7ac8ffa4c");
#else
		AssertExactAssemblyTypeManifest(
			typeof(LiquidWalletState).Assembly,
			"WalletWasabi",
			1_695,
			"951bc46cebad08c8bd90231ef19d2271a2515903a029db458b0eeb398f66a08c");
		AssertExactAssemblyTypeManifest(
			typeof(LiquidWalletCoinControlTests).Assembly,
			"WalletWasabi.Tests",
			1_654,
			"d5b50028243a78301214878d21909e4d9bb27bac916f951ec6c103cc8c7cb738");
#endif
	}
