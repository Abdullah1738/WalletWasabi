...
public class LiquidWalletCoinControlTests
{
	...
	private static void AssertExactAssemblyTypeManifestsMatchBase()
	{
		...
		AssertExactAssemblyTypeManifest(
			...
			"WalletWasabi",
			1_770,
			"0995282af250b272b14903c5161ca45151a82a3ed6eed6f628b52ad25d21b85b",
			permittedAddedProductionTypes);
		AssertExactAssemblyTypeManifest(
			typeof(LiquidWalletCoinControlTests).Assembly,
			"WalletWasabi.Tests",
			1_783,
			"588e4b2de50ba3990151c3ed48180f4cef8b64a646b2163c20efbe2b43977ef1",
		...
		AssertExactAssemblyTypeManifest(
			...
			"WalletWasabi",
			1_767,
			"2011204861688dca4a2102e45aae5d026d8075e1be21f12806fc06c3726c6318",
			permittedAddedProductionTypes);
		AssertExactAssemblyTypeManifest(
			typeof(LiquidWalletCoinControlTests).Assembly,
			"WalletWasabi.Tests",
			1_759,
			"699d32300d9f786b2d6554460f75d6a93859022084fe0110e2995be2dd70b9ee",
			permittedAddedTestTypes);
#endif
	}
		...
		IReadOnlyCollection<string>? permittedAddedTypes = null)
	{
		...
		{
			if (!rows.Remove(addedType))
			{
				missingAdded.Add(addedType);
			}
		}
		if (missingAdded.Count != 0)
		{
			throw new Xunit.Sdk.XunitException(BuildManifestMismatchDump(
				assembly, expectedSimpleName, missingAdded, []));
		}
